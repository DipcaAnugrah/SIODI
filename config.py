...
# Waktu manual rata-rata per dokumen berdasarkan pengujian nyata:
# - 12 gambar per jenis (3 normal, 3 miring, 3 tertutup bayangan+miring, 3 blur/jauh)
# - Proses: membaca setiap field lalu mengganti nama file sesuai isi
# - KTP : 16 mnt 23 dtk  / 12 = 81.9 dtk  ≈ 82 dtk/dok
# - KK  : 15 mnt 32 dtk  / 12 = 77.7 dtk  ≈ 78 dtk/dok
# - SIM : 14 mnt 52 dtk  / 12 = 74.3 dtk  ≈ 74 dtk/dok
MANUAL_TIME_SECONDS = {"ktp": 82, "kk": 78, "sim": 74, "unknown": 78}
